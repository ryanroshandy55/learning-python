...
# Arguments are specified after the function name, inside the parantheses. You can add as manny arguments as you want
# just separate them with a comma
# The following example has a function with one argument (fname). When the function is called,
# we pass along a first name, which is used inside the function to print the full name.
def function(fname):
    print(fname,", Hello & welcome to our place")
...
def my_function(fname, lname):
    print( "Hello, welcome " + fname + " " + lname)
    
my_function("Rian", "Kesat")
...
#   File "E:\_code\Python\fundamentals\15_functions.py", line 147, in <module>
#     my_function(x = 3)
...
# my_function(3)
# Traceback (most recent call last):
#   File "E:\_code\Python\fundamentals\15_functions.py", line 176, in <module>
#     my_function(3)
